...
Un CSP è diff-arc consistent se per ogni vincolo AllDifferent $C$ qualunque edge in $GV(C)$ appartiene ad almeno un matching della stessa dimensione dell'insieme di variabili di $C$.v b
