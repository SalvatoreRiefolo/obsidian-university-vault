...
- $S$ è una matrice diagonale, con elementi in ordine decrescente sulla diagonale.
...
La matrice ridotta, chiamata $M_S$, contiene quindi ancora un vettore per ogni documento, ma in meno spazio (vengono eliminate delle colonne).
