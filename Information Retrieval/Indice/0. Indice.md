In IR is utilizza un indice inverso per la ricerca di documenti all'interno della documentazione.
...
### Requisiti di spazio
Il vocabolario è **piccolo** ([[1. Proprietà del Linguaggio Naturale#Legge di Heaps|legge di Heaps]]) e può essere contenuto in memoria principale. Può essere ridotto ulteriormente attraverso stemming o compressione.
