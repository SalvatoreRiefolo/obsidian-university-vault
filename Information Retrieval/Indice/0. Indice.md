...
### Requisiti di spazio
Il vocabolario è **piccolo** ([[1. Proprietà del Linguaggio Naturale#Legge di Heap|legge di Heaps]]) e può essere contenuto in memoria principale. Può essere ridotto ulteriormente attraverso stemming o compressione.
